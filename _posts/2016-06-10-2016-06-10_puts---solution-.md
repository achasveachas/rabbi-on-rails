...
![](/assets/images/posts/2016-06-10-2016-06-10_puts---solution--0.jpeg)
...
![](/assets/images/posts/2016-06-10-2016-06-10_puts---solution--1.png)

(Credit: [XKCD](https://xkcd.com/974/))

P.S. If anyone is interested, the project can be found [here](https://github.com/achasveachas/ttt-with-ai-project-v-000), If anyone has any suggestions on how it can be improved, especially the #opposite\_corner method in the article, I would be extremely thankful.

* * *

_Originally published at_ [_yechiel.me_](http://yechiel.me/2016/06/10/puts_solution/) _on June 10, 2016._
