...
permalink: /add-sms-notifications-to-your-rails-app-using-twilio-20kd
header:
...
![sceenshot](/assets/images/posts/2018-04-08-add-sms-notifications-to-your-rails-app-using-twilio-20kd-3af288.png)
...
![screenshot](/assets/images/posts/2018-04-08-add-sms-notifications-to-your-rails-app-using-twilio-20kd-2ee752.png)
...
![screenshot](/assets/images/posts/2018-04-08-add-sms-notifications-to-your-rails-app-using-twilio-20kd-34064a.png)
...
![screenshot](/assets/images/posts/2018-04-08-add-sms-notifications-to-your-rails-app-using-twilio-20kd-110a7e.png)
...
We then take the string we got back from `parse_sms` and create a TwiML response object using the response as the body. We then convert the TwiML object to XML and send it back to Twilio.
...
* * *
*If you liked that you can read more by Yechiel Kalmenson on his blog [Rabbi On Rails](https://blog.yechiel.me) or follow him on Twitter [@yechielk](https://twitter.com/yechielk)*