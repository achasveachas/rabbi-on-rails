...
I recently wrote a [Quora post](https://www.quora.com/How-and-why-did-you-pick-an-online-coding-bootcamp-course/answer/Yechiel-Kay) describing my reasons for joining Learn. Figured I would share it here as well:
...
![](/assets/images/posts/2016-09-06-2016-09-06_Learning-with-Learn-0.jpeg)

#### Answer:

I’m currently in middle of taking the Full Stack course at Flatiron’s [Learn-co](http://learn.co/with/achasveachas)
...
As mentioned in the question there are many courses out there. After looking around quite a bit there were a few factors that went into choosing [Flatiron](https://www.quora.com/profile/Flatiron-School-1):
...
- **Proven results:** all bootcamps make big claims about their hiring record, average salaries, etc. Flatiron is the only one I’ve seen that [published their results](http://blog.flatironschool.com/announcing-flatiron-schools-2015-jobs-report/#) and had them verified by a third party.
- **Working environment:** Taking Flatiron’s intro course (which anyone can try for free [here](http://learn.co/with/achasveachas)) I was struck by the difference between their way of learning and most other courses I tried. Most online courses provide you with a sterile environment that looks nothing like the environment you would use in real life. At Learn you write code in Atom, run it in your terminal and then push it to GitHub so it becomes a permanent part of your portfolio.
...
Those were pretty much the main reasons that had me leaning towards [Learn](http://learn.co/with/achasveachas). I obviously still had many questions. Interestingly, just at that time [Avi Flombaum](https://www.quora.com/profile/Avi-Flombaum) (the dean of flatiron and best teacher out there (more on that later)) held a Quora [session](https://www.quora.com/session/Avi-Flombaum/1). I asked a few questions, followed a few others, and was finally hooked.
...
So those are my reasons. You can definitely try on your own by taking their [free intro course](http://learn.co/with/achasveachas). If you have any questions feel free to to ask.

* * *

_Originally published at_ [_www.quora.com_](https://www.quora.com/How-and-why-did-you-pick-an-online-coding-bootcamp-course/answer/Yechiel-Kay)_._
